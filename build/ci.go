...
import (
	...
	"github.com/nim4/go-arbitrum/crypto/signify"
	"github.com/nim4/go-arbitrum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/nim4/go-arbitrum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/nim4/go-arbitrum/internal/version.gitDate="+env.Date)
	}
